...
public class EastAsiaCountriesDao {
    private static EastAsiaCountriesDao instance = null;

    public  EastAsiaCountriesDao Instance() {
        if (instance == null) {
            synchronized (EastAsiaCountriesDao.class) {
                if (instance == null) {
                    instance = new EastAsiaCountriesDao();
                }
            }
        }
        return instance;
